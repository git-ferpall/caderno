...
<div id="popup-overlay" class="popup d-none">
    ...
    <form id="form-solicitar-fungicida" class="popup-form">
        ...
        <div class="popup-actions">
        <button type="button" class="popup-btn fundo-cinza-b cor-preto" 
                onclick="this.closest('.popup-box').classList.add('d-none'); document.getElementById('popup-overlay').classList.add('d-none');">
            Cancelar
        </button>
