...
<div id="popup-overlay" class="popup d-none">
    ...
    <div class="popup-box popup-silo d-none" id="popup-silo-input">
        <div class="popup-silo-shell">
            <h2 class="popup-silo-title" id="popup-silo-input-title">Informe o nome</h2>
            <label class="popup-silo-label" for="popup-silo-input-field" id="popup-silo-input-label">Nome</label>
            <input type="text" id="popup-silo-input-field" class="popup-silo-field" autocomplete="off" placeholder="Digite aqui...">
            <div class="popup-silo-actions">
