...
require_once __DIR__ . '/../sso/verify_jwt.php'; // script que valida token JWT e retorna payload
...
// Captura dados do usuário via JWT
$payload = verify_jwt();
...
// Se for CPF, prioriza campo correto
