      ...
      <div class="sistema-main container">
        <form id="form-plantio" class="main-form">
          ...
          <div class="form-campo">
            ...
            <button class="add-btn add-area" type="button">+</button>
          </div>

          <!-- PRODUTOS -->
          <div class="form-campo">
            <label for="produto">Produtos cultivados</label>
            <div id="lista-produtos">
              <div class="form-box form-box-produto">
                <select name="produto[]" class="form-select form-text produto-select" required>
                  <option value="">Selecione o produto</option>
                </select>
                <button class="remove-btn remove-produto" type="button">x</button>
              </div>
            </div>
            <button class="add-btn add-produto" type="button">+</button>
          </div>
