...
<head>
    ...
    <link rel="stylesheet" href="../css/custom/ia-fitossanitaria.css?v=2">
...
<body class="page-ia-fitossanitaria">
    ...
    <div id="conteudo" class="ia-fs-layout">
        ...
        <main id="ia-fitossanitaria" class="sistema ia-fs-main">
            <div class="ia-fs-overlay">
                <div class="ia-fs-wrapper">
                    <a href="/home/relatorios" class="ia-fs-voltar">← Voltar para relatórios</a>
                    ...
                    <div class="ia-fs-toolbar">
                        ...
                        <button type="button" id="ia-fs-atualizar" class="main-btn fundo-verde ia-fs-btn-atualizar">
                            <span class="main-btn-text">Atualizar painel</span>
                        </button>
                    </div>

                    <div id="ia-fs-overview" class="ia-fs-panel ia-fs-overview" hidden>
        ...
        <script src="../js/ia-fitossanitaria.js?v=2"></script>
