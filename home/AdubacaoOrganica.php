...
<head>
  ...
  <title>Adubação Orgânica - Caderno de Campo</title>
...
<body>
  ...
  <div id="conteudo">
    ...
    <main class="sistema">
      <div class="page-title">
        <h2 class="main-title cor-branco">Apontamento - Adubação Orgânica</h2>
      </div>

      <div class="sistema-main container">
        <form id="form-adubacao-organica" class="main-form">
          ...
          <div class="form-campo">
            ...
            <input type="text" id="tipo" name="tipo" class="form-text" placeholder="Ex: Esterco bovino, composto, húmus, etc." required>
          </div>

          <!-- Quantidade -->
          <div class="form-campo">
            <label for="quantidade">Quantidade (kg/planta)</label>
            <input type="number" id="quantidade" name="quantidade" class="form-text" placeholder="Ex: 3.5" step="0.01" required>
          </div>
          ...
          <!-- N° de referência da amostra -->
          <div class="form-campo">
            <label for="n_referencia">N° de referência da amostra</label>
            <input type="text" id="n_referencia" name="n_referencia" class="form-text" placeholder="Ex: AM-ORG-2025-001">
          </div>

          <!-- Observações -->
          <div class="form-campo">
            <label for="obs">Observações</label>
            <textarea id="obs" name="obs" class="form-text form-textarea" placeholder="Insira observações relevantes..."></textarea>
          </div>
  ...
  <script src="../js/adubacao_organica.js"></script>
</body>
</html>
